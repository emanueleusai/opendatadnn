...
the_name='step2_QCD600to3000_02'
...
config.JobType.psetName = 'step2_QCDPt_15_3000_Flat_V27.py'
...
config.Data.userInputFiles = open('step1_QCDPt_15to3000_02').readlines()
