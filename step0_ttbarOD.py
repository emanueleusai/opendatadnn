...
#from stepLHE_ttbarOD import lhefiles
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('root://cmsxrootd-site.fnal.gov//store/group/lpcml/eusai/lhe2/emanuele.lhe'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step0_ttbarOD.root'),
