...
the_name='step1_QCD600to3000_02'
...
config.JobType.psetName = 'step1_QCDPt_15_3000_Flat_V27.py'
...
config.Data.userInputFiles = open('step0_QCDPt_15to3000_02').readlines()
