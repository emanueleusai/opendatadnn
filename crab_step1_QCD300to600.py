...
config.Data.userInputFiles = open('step0_QCD300to600_Emanuele').readlines()+open('step0_QCD300to600_Gabriele').readlines()+open('step0_QCD300to600_Meenakshi').readlines()
