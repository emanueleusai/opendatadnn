...
the_name='step1_TtbarFromOpen_02'
...
config.JobType.psetName = 'step1_QCDPt_15_3000_Flat_V27_noHLT.py'
...
config.Data.userInputFiles = open('step0_TtbarFromOpen').readlines()
